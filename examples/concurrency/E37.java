...
//Exercise 37: (2) Modify CarBuilder.java to add another stage to the car-building process, whereby you add the exhaust system, body,
// and fenders. As with the second stage, assume these processes can be performed simultaneously by robots.
...
class Car {
    ...
    public synchronized String toString() {
        return "Car " + id + " [" + " engine: " + engine
                ...
                + exhaust + " body: " + body + " fenders: " + fenders + " ]";
    }
}
